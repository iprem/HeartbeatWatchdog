...
package com.example.prasannakumarvardi.myapplication.backend.userEndpoint;
...
public class UserEndpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://iprem-guestbook.appspot.com/_ah/api/";
  ...
  public class Get extends UserEndpointRequest<com.example.prasannakumarvardi.myapplication.backend.userEndpoint.model.User> {
    ...
    protected Get(java.lang.String email) {
      super(UserEndpoint.this, "GET", REST_PATH, null, com.example.prasannakumarvardi.myapplication.backend.userEndpoint.model.User.class);
   ...
   *
   * @param content the {@link com.example.prasannakumarvardi.myapplication.backend.userEndpoint.model.User}
   * @return the request
   */
  public Insert insert(com.example.prasannakumarvardi.myapplication.backend.userEndpoint.model.User content) throws java.io.IOException {
    Insert result = new Insert(content);
    initialize(result);
    return result;
  }

  public class Insert extends UserEndpointRequest<com.example.prasannakumarvardi.myapplication.backend.userEndpoint.model.User> {
     ...
     * @since 1.13
     */
    protected Insert(com.example.prasannakumarvardi.myapplication.backend.userEndpoint.model.User content) {
      super(UserEndpoint.this, "POST", REST_PATH, content, com.example.prasannakumarvardi.myapplication.backend.userEndpoint.model.User.class);
    }
  ...
  public class List extends UserEndpointRequest<com.example.prasannakumarvardi.myapplication.backend.userEndpoint.model.CollectionResponseUser> {
     ...
     */
    protected List() {
      super(UserEndpoint.this, "GET", REST_PATH, null, com.example.prasannakumarvardi.myapplication.backend.userEndpoint.model.CollectionResponseUser.class);
    }
   ...
   * @return the request
   */
  public Patch patch(java.lang.String email, com.example.prasannakumarvardi.myapplication.backend.userEndpoint.model.User content) throws java.io.IOException {
    Patch result = new Patch(email, content);
    initialize(result);
    return result;
  }

  public class Patch extends UserEndpointRequest<com.example.prasannakumarvardi.myapplication.backend.userEndpoint.model.User> {
     ...
     * @since 1.13
     */
    protected Patch(java.lang.String email, com.example.prasannakumarvardi.myapplication.backend.userEndpoint.model.User content) {
      super(UserEndpoint.this, "PATCH", REST_PATH, content, com.example.prasannakumarvardi.myapplication.backend.userEndpoint.model.User.class);
      this.email = com.google.api.client.util.Preconditions.checkNotNull(email, "Required parameter email must be specified.");
    }
  ...
  public class Remove extends UserEndpointRequest<Void> {
   ...
   * @return the request
   */
  public Update update(java.lang.String email, com.example.prasannakumarvardi.myapplication.backend.userEndpoint.model.User content) throws java.io.IOException {
    Update result = new Update(email, content);
    initialize(result);
    return result;
  }

  public class Update extends UserEndpointRequest<com.example.prasannakumarvardi.myapplication.backend.userEndpoint.model.User> {
     ...
     * @since 1.13
     */
    protected Update(java.lang.String email, com.example.prasannakumarvardi.myapplication.backend.userEndpoint.model.User content) {
      super(UserEndpoint.this, "PUT", REST_PATH, content, com.example.prasannakumarvardi.myapplication.backend.userEndpoint.model.User.class);
      this.email = com.google.api.client.util.Preconditions.checkNotNull(email, "Required parameter email must be specified.");
    }
